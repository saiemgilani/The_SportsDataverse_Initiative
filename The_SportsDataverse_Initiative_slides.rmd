...
We will be working with `cfbfastR` (on CRAN), `hoopR` (not yet published on CRAN), and `wehoop` (on CRAN). I prefer the `pacman` package for easy package loading and installation:
...
* `#CMSAC21 hosts`: Rebecca, Sam, Ron and Carlie 
