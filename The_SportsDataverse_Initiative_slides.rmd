...
opengraph:
  image: 
    src: "https://github.com/saiemgilani/The_SportsDataverse_Initiative/blob/main/figures/sdv-blue.png?raw=true"
  twitter:
...
.pull-right[
```{r, eval = TRUE, out.width = "47%", echo = FALSE}
...
---
### You get it, but let me explain anyway
