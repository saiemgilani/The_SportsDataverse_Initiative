...
\texttt{cfbfastR} is the unofficial R client for the \href{CollegeFootballData.com}{https://www.CollegeFootballData.com} API, a resource provided by Bill Radjewski, which allows programmatic access a database with a number of views for users to query with a free API key\cite{radjewski_2016}. 
